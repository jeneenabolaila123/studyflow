...
def grounded_answer(doc_id: str, question: str) -> Dict[str, Any]:
    ...
    if is_greeting(q_lower):
        greeting = "Hi! Ask me anything about this PDF/note and Iâ€™ll answer using its content."
        return {
            "answer": greeting,
            "reply": greeting,
            "chunks": [],
    ...
    if not chunks:
        fallback = "I couldnâ€™t find this information in the uploaded PDF/note. Could you ask about something shown in the material?"
        return {
            "answer": fallback,
            "reply": fallback,
            "chunks": [],
...
""".strip()
    ...
    if not answer:
        answer = "I couldnâ€™t generate an answer right now. Please try again."
